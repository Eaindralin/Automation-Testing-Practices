...
WebUI.click(findTestObject('Object Repository/HRMS_Web/ClockIn_Manual/Page_HRMS/button_Manual'))
...
WebUI.click(findTestObject('Object Repository/HRMS_Web/ClockIn_Manual/Page_HRMS/div_13'))

WebUI.click(findTestObject('Object Repository/HRMS_Web/ClockIn_Manual/Page_HRMS/input_Time_mat-input-2'))

WebUI.click(findTestObject('Object Repository/HRMS_Web/ClockIn_Manual/Page_HRMS/span_9'))

WebUI.click(findTestObject('Object Repository/HRMS_Web/ClockIn_Manual/Page_HRMS/span'))

WebUI.click(findTestObject('Object Repository/HRMS_Web/ClockIn_Manual/Page_HRMS/span_Ok'))

CustomKeywords.'click_radio.clickUsingJS.click_radio_button'(findTestObject('HRMS_Web/ClockIn_Manual/Page_HRMS/div_Time_mat-radio-outer-circle'), 
    30)
...
WebUI.setText(findTestObject('Object Repository/HRMS_Web/ClockIn_Manual/Page_HRMS/textarea_Reason_reason'), 'WFH')
